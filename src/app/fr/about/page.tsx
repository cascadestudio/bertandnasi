          ...
          <div className="flex-1 py-6 px-5">
            <div className="text-left space-y-6">
              <p className="text-black text-base leading-relaxed">
                Bertand et Nasi sont un duo d'artistes-performeurs qui se sont
                rencontrés en 2015 et ont depuis créé un répertoire entier de
                spectacles au milieu d'une période d'austérité nationale et
                internationale. Leur travail, à son tour, est dépouillé et
                minimaliste, tout en traitant d'idées et d'émotions complexes.
                Leurs spectacles se situent quelque part entre la performance,
                la danse et le théâtre, mais si vous deviez les coincer
                là-dessus, ils diraient probablement que c'est du théâtre.
              </p>
              <p className="text-black text-base leading-relaxed">
              ...
              <p className="text-black text-base leading-relaxed">
                ...
                à la mémoire de Huw Chadbourn, qui célèbre le travail d'artistes
                contemporains réinventant le théâtre et la performance de
                nouvelles manières et pour de nouveaux publics.
              </p>
