...
export const calendar = defineType({
  ...
  fields: [
    // Event Details
    {
      ...
      description:
        "Select the show from your shows list. The main image will be taken from the show.",
    },
    {
      name: "dates",
      ...
      description:
        'Click "Add item" and use the calendar picker to select performance dates. You can add multiple dates for the same show.',
    },
    {
      name: "venue",
    ...
    },
    {
      ...
      description:
        "Upload additional images specific to this calendar event. The show's main image will be used automatically, these are extra images.",
    },
  ],
